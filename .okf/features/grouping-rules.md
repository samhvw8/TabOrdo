...
- **Background auto-group** uses rules only when `useRules` is on. A rule creates a group even for a single tab, and domain fallback needs 2 or more tabs. Ignored URLs are skipped.[^bg-index]
