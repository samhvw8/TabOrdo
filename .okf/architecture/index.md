...
* [Undo stack](undo-stack.md) - lib/undo.ts keeps a 20-entry close/group undo stack in chrome.storage.session, with durable serialised pushes shared across the popup, side panel and background realms.
